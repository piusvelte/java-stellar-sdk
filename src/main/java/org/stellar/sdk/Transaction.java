...
public class Transaction {
    ...
    public String toEnvelopeXdrBase64() {
        try {
            ...
            return new Base64().encodeBase64String(outputStream.toByteArray());
        } catch (IOException e) {
    ...
    public static class Builder {
        ...
        /**
         * Adds a new <a href="https://www.stellar.org/developers/learn/concepts/list-of-operations.html" target="_blank">operation</a> to this
         * transaction.
         *
         * @param operation
